...
const (
	...
	ACMEProvisioner_ANDROID_KEY ACMEProvisioner_AttestationFormatType = 4
)
...
const file_linkedca_provisioners_proto_rawDesc = "" +
	...
	"\n" +
	"object_ids\x18\a \x03(\tR\tobjectIds\"\xc0\x04\n" +
