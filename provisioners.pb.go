...
func (Webhook_Kind) EnumDescriptor() ([]byte, []int) {
	return file_linkedca_provisioners_proto_rawDescGZIP(), []int{22, 0}
}
...
func (Webhook_CertType) EnumDescriptor() ([]byte, []int) {
	return file_linkedca_provisioners_proto_rawDescGZIP(), []int{22, 1}
}
...
var file_linkedca_provisioners_proto_msgTypes = make([]protoimpl.MessageInfo, 23)
...
func file_linkedca_provisioners_proto_init() {
	...
	file_linkedca_provisioners_proto_msgTypes[22].OneofWrappers = []interface{}{
